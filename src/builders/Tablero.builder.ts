import { CasillaTypeEnum, OrientacionCasilla } from '@prisma/client';
import { CasillaModel } from '../models/CasillaModel';
import { TableroModel } from 'src/models/TableroModel';

export class TableroBuilder {
  public casillas: CasillaModel[] = [];
  public tableroSize: number;
  public meta: number = 0;

  constructor(tableroSize: number) {
  ...
  // Devuelve el tablero construido
  public build(): TableroModel {
